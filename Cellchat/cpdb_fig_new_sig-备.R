...
load('new_cpdb_fig_sigmeans.Rdata')
save(pldf,peri_meansdf,core_meansdf,peri_pvalsdf,core_pvalsdf,all_meansdf,all_pvalsdf,
     file = 'new_cpdb_fig_sigmeans.Rdata')



peri = 'E:/R/glioma-infiltrate/new_cpdb_peri/'
core = 'E:/R/glioma-infiltrate/new_cpdb_core/'


core_pvals <- read.delim(paste0(core,"pvalues.txt"), check.names = FALSE)
core_means <- read.delim(paste0(core,"significant_means.txt"), check.names = FALSE)

peri_pvals <- read.delim(paste0(peri,"pvalues.txt"), check.names = FALSE)
peri_means <- read.delim(paste0(peri,"significant_means.txt"), check.names = FALSE)
