...
load('infil_macrophage_pseudobulk.Rdata')
...
save(cluster_counts,pbmc3,cluster_metadata,dds,res,res_tbl,sig_res,
     ...
     file='infil_macrophage_pseudobulk.Rdata')
...
##筛选microglia
cluster_metadata <- metadata[which(metadata$sccelltype == 'Macrophage'), ]
